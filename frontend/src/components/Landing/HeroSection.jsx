...
const HeroSection = ({ animatedStats }) => {
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 relative z-10 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <button
                ...
                className="group px-8 py-4 bg-slate-800/80 hover:bg-slate-700/80 text-white border border-slate-700 hover:border-slate-600 rounded-xl font-semibold transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2"
              >
            ...
            {/* Stats Row */}
            <div className="flex items-center justify-center lg:justify-start gap-8 sm:gap-12 pt-8 border-t border-slate-800/50">
              {[
          ...
          <div className="relative perspective-1000 mt-8 lg:mt-0">
            {/* Glow Effect */}
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/20 via-indigo-500/20 to-purple-500/20 rounded-3xl blur-2xl opacity-60 animate-pulse" />
            ...
            <div
              ...
              className="relative bg-slate-900/90 backdrop-blur-sm border border-slate-700/50 rounded-2xl shadow-2xl overflow-hidden transform-gpu"
            >
              {/* Editor Header */}
              <div className="flex items-center justify-between px-4 py-3 bg-slate-800/80 border-b border-slate-700/50">
                ...
                <div className="text-xs text-slate-500">Python 3.11</div>
              </div>
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div className="flex">
                  {/* Line Numbers */}
                  <div className="pr-4 text-slate-600 select-none text-right">
                  ...
                  <div className="flex-1 space-y-0">
                    ...
                    <div className="pl-4"><span className="text-slate-500"># Kadane's Algorithm - O(n)</span></div>
                    <div className="pl-4"><span className="text-slate-300">current_sum</span> = nums[<span className="text-green-400">0</span>]</div>
                    <div className="pl-4"><span className="text-slate-300">max_sum</span> = nums[<span className="text-green-400">0</span>]</div>
                    <div className="pl-4">&nbsp;</div>
                    <div className="pl-4"><span className="text-purple-400">for</span> <span className="text-white">num</span> <span className="text-purple-400">in</span> nums[<span className="text-green-400">1</span>:]:</div>
                    <div className="pl-8"><span className="text-slate-300">current_sum</span> = <span className="text-yellow-400">max</span>(num, current_sum + num)</div>
                    <div className="pl-8"><span className="text-slate-300">max_sum</span> = <span className="text-yellow-400">max</span>(max_sum, current_sum)</div>
                    <div className="pl-4">&nbsp;</div>
                    <div className="pl-4"><span className="text-purple-400">return</span> <span className="text-slate-300">max_sum</span></div>
                  </div>
                </div>
              </div>

              {/* Editor Footer */}
              <div className="flex items-center justify-between px-4 py-2 bg-slate-800/50 border-t border-slate-700/50 text-xs">
